...
<body>
    <div class="container">
        ...
        <div class="content">
            <div class="section">
                ...
                <div class="features">
                    <div class="feature">
                        <h3>🔬 Ilmiy Tahlil</h3>
                        <p>2PL IRT (Item Response Theory) model asosida talabalarning qobiliyati va savollarning qiyinlik darajasini aniqlab beradi.</p>
                    </div>
                    ...
                    <div class="feature">
                        ...
                        <p>O'zbekiston Oliy va O'rta Maxsus Ta'lim Vazirligi standartlari bo'yicha baholar taqsimlaydi.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="section">
                ...
                <p>Bot O'zbekiston Oliy va O'rta Maxsus Ta'lim Vazirligi standartlari bo'yicha baholar beradi:</p>
        ...
        <div class="footer">
            ...
            <p>O'zbekiston Oliy va O'rta Maxsus Ta'lim Vazirligi standartlari asosida</p>
        </div>
    </div>
</body>
</html>
